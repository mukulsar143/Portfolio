...
function Footer() {
  return (
    <footer className="bg-gradient-to-t from-gray-800 to-black text-white py-12 px-6">
      <div className="container mx-auto text-center">
        <div className="footer--link--container mb-8">
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  ...
                  duration={500}
                  to="heroSection"
                  className="text-lg hover:text-indigo-400 transition-all duration-300"
                >
                  Home
                </Link>
              </li>
        ...
        <div className="footer--social--icon mb-8">
          <ul className="flex justify-center space-x-6 sm:space-x-4 md:space-x-6">
            <li>
              <a
        ...
        <div className="text-sm text-gray-400 mt-6">
          <p>&copy; {new Date().getFullYear()} Mukul Sarkar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
